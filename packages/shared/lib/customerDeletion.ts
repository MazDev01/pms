...
//
//   เพราะดีลทั้ง 2 อันปิดการขายสำเร็จไปแล้ว และหน้าลีด "ตั้งใจซ่อนดีลที่ปิดแล้ว"
...
//   • ยังเดินอยู่ = งานขายที่ยังทำอยู่ → กันไว้เหมือนเดิม และอันนี้ผู้ใช้เห็นในหน้าลีดจริง
...
export function customerDeletionImpact(
  ...
  // ใบที่ผูกกับลูกค้าโดยตรง + ใบที่ผูกกับดีลที่จบแล้ว (dealId = numId ของลีด)
