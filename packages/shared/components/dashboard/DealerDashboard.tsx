...
export default function DealerDashboard() {
  ...
  const teamPerf = useMemo(() => {
    ...
    quotesIn.forEach(q => {
      ...
      if (!e) return;
      e.quotes++;
      // ⚠️ "ยอดปิดการขาย" ต้องมาจากใบที่ชนะจริง ไม่ใช่มูลค่าประเมินของลีด (แก้ 10 ส.ค. 69)
      //   เดิมบวกจาก l.value ของลีดสถานะ PAID ซึ่งเป็น "ตัวเลขที่เซลส์เดาไว้ตอนเปิดลีด"
