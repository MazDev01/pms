...
test("[ux·hq] กระดิ่งแจ้งเตือนฝั่ง HQ เป็นเรื่องของเครือ ไม่ใช่งานขายของตัวแทน", async ({ page }) => {
  ...
  // เรื่องที่ขึ้นต้องมาจากกฎแจ้งเตือนของสำนักงานใหญ่ (ตั้งที่ ตั้งค่า › การแจ้งเตือน)
  await expect(page.getByText("ตามกฎแจ้งเตือนของสำนักงานใหญ่").first()).toBeVisible();
});
