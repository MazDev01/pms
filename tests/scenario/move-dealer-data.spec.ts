...
//
// เคยพังมาแล้วจริง (14 ส.ค. 69): ย้ายทีละตารางตามลำดับ leads → customers ทำให้ลีดที่ย้ายไปแล้ว
...
test("[admin] ย้ายข้อมูลไปสาขาที่รับช่วงต่อ แล้วลบสาขาเดิมได้", async ({ request }) => {
  ...
  // 2) ใส่ข้อมูลที่ "ผูกกันจริง" ให้สาขาต้นทาง — ลูกค้า → ลีดของลูกค้ารายนั้น → ใบเสนอราคาของลีดนั้น
