...
const ยิงข้อความเตือน = (page: import("@playwright/test").Page, msg: string) =>
  page.evaluate((m) => window.dispatchEvent(new CustomEvent("pms:repo-save-error", { detail: m })), msg);
