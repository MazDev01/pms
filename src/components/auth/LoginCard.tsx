    ...
    <div className="flex min-h-[600px] flex-col bg-white px-8 py-8 sm:px-12">
      <div className="flex flex-1 items-center justify-center">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1.5 text-sm text-slate-500">เข้าสู่ระบบเพื่อใช้งานระบบ</p>
            ...
            <div>
              ...
              <div className={inputWrap}>
                ...
                <input id="login-email" type="text" inputMode="email" autoComplete="username" value={email}
                  onChange={(e) => setEmail(e.target.value)} placeholder="dealer@example.com" required className={inputEl} style={noOutline} />
              </div>
            </div>
