-- Benjamin PMS — M9 Phase 4: เพิ่ม byDealer ใน lead_summary
--
-- ปลด leadVsQuote/dealerPerf ทั้ง /hq/leads และ /hq/pipeline (ต้องนับลีด + "ถึงขั้นเสนอราคา" รายสาขา)
--   quoted = ลีดที่ไปถึงขั้นเสนอราคาขึ้นไป (QUOTED/FOLLOWUP/NEGO/PAID) — ตรงกับ QUOTED_UP ฝั่ง client
-- (region/province ผู้เรียก roll-up จาก byDealer เอง โดยใช้ทะเบียนตัวแทน)
