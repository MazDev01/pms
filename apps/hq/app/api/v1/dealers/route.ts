// เส้นทาง /api/v1/dealers — handler จริงอยู่ในแพ็กเกจกลาง
export { dealersGET as GET, dealersPUT as PUT, dealersDELETE as DELETE } from "@pms/shared/server/v1/reference";
