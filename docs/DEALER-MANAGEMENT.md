...
| จังหวัดรับผิดชอบ | ✓ | `Dealer.provinces[]` | ใช้ auto-routing ลูกค้าเป้าหมาย |
...
| ลบจริง | ไม่อนุญาต (ข้อมูลลูกค้าเป้าหมาย/โครงการอ้างอิงอยู่) |

> ปิดดีลเลอร์ → ลูกค้าเป้าหมาย/โครงการที่ค้างควรเตือน HQ ให้ **โอนให้ดีลเลอร์อื่น** ก่อน

---

## 4. จุดเชื่อมกับส่วนอื่น
- **Auto-routing ลูกค้าเป้าหมาย** ← `Dealer.provinces[]`
